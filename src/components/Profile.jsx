...
const Profile = () => {
  ...
  return (
    <section
      id="profile"
      ref={profileRef}
      className="w-full min-h-screen bg-[#FAF9F5] text-[#2b1200] px-6 md:px-12 py-24 overflow-hidden"
    >
      <div id="profile-card" className="max-w-7xl mx-auto">

        {/* TOP HEADER */}
        <div className="flex items-end justify-between border-b-2 border-[#2b1200] pb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 mt-20">
          ...
          <div className="lg:col-span-7 relative">
            ...
            {/* LIME BAR */}
            <div className="profile-bar absolute left-0 top-2 w-2 h-[calc(100%-8px)] bg-[#CCFF00]" />
            ...
            {/* SMALL LABEL */}
            <div className="profile-label mt-12 pl-8 md:pl-12 font-mono text-xs tracking-[0.25em] uppercase text-[#2b1200]/60">
              Curious by default.
              <br />
          ...
          <div className="lg:col-span-5 flex flex-col gap-10">
            ...
            <div className="profile-bio border border-[#2b1200] p-8 md:p-10">
              <span className="font-mono text-xs tracking-[0.25em] uppercase text-[#2b1200]/50">01 — PROFILE</span>
            ...
            {/* INFO GRID */}
            <div className="profile-info grid grid-cols-2 border-t border-[#2b1200]">

              <div className="py-5 border-b border-r border-[#2b1200]">
              ...
              <div className="py-5 border-b border-[#2b1200] pl-5">
              ...
              <div className="py-5 border-r border-[#2b1200]">
              ...
              <div className="py-5 pl-5">
                ...
                <p className="mt-2 font-bold uppercase flex items-center gap-2">
                  <span className="w-2.5 h-2.5 rounded-full bg-[#CCFF00]" />Building</p>
              </div>
